...
public class MyTest extends WebdriverSettings {
    ...
    public void Test2() throws InterruptedException {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            //TimeUnit.MILLISECONDS.sleep(7000);.ty-btn.ty-btn__secondary.cm-notification-close
    ...
    public void Test4() throws InterruptedException {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            double discount = Integer.parseInt(sale.getText().replace("%", ""));
            System.out.println(discount);
            double salePrice = pri - pri * (discount / 100);
